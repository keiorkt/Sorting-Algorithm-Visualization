...
QT_MOC_LITERAL(5, 26, 5), // "index"
QT_MOC_LITERAL(6, 32, 4) // "done"

    },
    "Sorting\0changed\0\0int*\0arr\0index\0done"
};
...
void Sorting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changed((*reinterpret_cast< int*(*)>(_a[1])),(*reinterpret_cast< int*(*)>(_a[2]))); break;
...
// SIGNAL 0
void Sorting::changed(int * _t1, int * _t2)
{
