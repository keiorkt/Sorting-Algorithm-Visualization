...
private:
    ...
    QString algorithm;
    QString shuffleType;
    QStringList algorithms = {"Bubble Sort","Insertion Sort","Selection Sort","Quicksort","Cocktail Sort","Merge Sort","Heap Sort","Gnome Sort","Counting Sort"};
...
public:
    ...
    void sort_counting(int* arr,int size);
